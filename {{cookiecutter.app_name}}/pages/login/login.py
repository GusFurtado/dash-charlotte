...
left_panel = ll.LoginForm(id="login-form")
...
def login(_, password, username, search):
    ...
    # Error on authentication
        ...
        return (
            no_update,
            html.Span(
                [html.I(className="fas fa-times-circle me-2"), html.Span(str(err))],
                className="red",
            ),
        )
    ...
    return (
        ...
        html.Span(
            [html.I(className="fas fa-check-circle me-2"), html.Span("Logged in!")],
            className="green",
        ),
    )
